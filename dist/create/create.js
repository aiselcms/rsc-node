...
const createCaptcha1 = async ({ image = Buffer.from((0, generate_1.backgroundSvg)(sizes.WIDTH, sizes.HEIGHT)), distort = false, rotate = false, fill = "#000", stroke = "#fff", strokeWidth = ".4", opacity = "0.5", } = {}) => {
...
exports.default = createCaptcha1;
